            ...
            <div class="row">
                <div class="col-md-3 col-md-offset-3">
                    <div class="form-group{{ $errors->has('codigo_materia') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="codigo_materia" id="codigo_materia" value="{{ old('codigo_materia') }}" placeholder="código">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group{{ $errors->has('materia') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="materia" id="materia" value="{{ old('materia') }}" placeholder="materia">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group{{ $errors->has('creditos') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="creditos" id="creditos" value="{{ old('creditos') }}" placeholder="créditos">
                    </div>
                </div>
            </div>
